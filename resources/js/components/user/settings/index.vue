        ...
        <div class="bg-gray-200 min-h-screen pt-2 font-mono my-16">
            <div class="container mx-auto">
                <div class="inputs w-full max-w-2xl p-6 mx-auto">
                    ...
                    <div class="w-full max-w-sm bg-gray-500 rounded-lg border border-gray-200 shadow-md dark:bg-gray-500 dark:border-gray-700">
                        <div class="flex flex-col items-center pb-10">
                            <img class="mb-3 w-24 h-24 rounded-full shadow-lg" :src="profile" alt="stock profile">
                    ...
                    <form class="mt-6 border-t border-gray-400 pt-4">
                        <div class='flex flex-wrap -mx-3 mb-6'>
                            <div class='w-full md:w-full px-3 mb-6 flex '>
                                <label class='flex uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>Email</label>
                                <button class="appearance-none bg-gray-200 text-gray-900 px-2 py-1 shadow-sm border border-gray-400 rounded-md ">Change Your Email</button>
...
export default {
    data(){
        return{
            profile: ('./public/Muscle_profile.jpeg')
        }
    },
    props: {
        user: ""
