<template>
    ...
    <div class="relative mt-24 bg-gray-500 w-3/4 mx-auto h-full rounded">
            <div class="grid gap-6 mb-6 md:grid-cols-3 ">
                ...
                <div>
                    <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Exercise</label>
                    <input type="text" id="reps"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                </div>
                <div>
        ...
        <button @click="sendExercise" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Excercise</button>
    </div>
</template>
<script>
...
export default{
    ...
    methods: {
         sendExercise() {
             axios.post("/workouts/create/save", this.formData.entries, {
                        headers: {
                            'Reason': 'Debug'
                        }
             }).then(
